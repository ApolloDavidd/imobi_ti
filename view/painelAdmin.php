                            ...
                            <tr> <!----Inicio LINHA -->
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        ...
                                        <a href="../controller/ctrlImovel.php?excluir_id=<?= $imovel->id ?>" class="btn btn-sm btn-outline-danger" title="Excluir" onclick="return confirm('Deseja excluir este imóvel?')">
